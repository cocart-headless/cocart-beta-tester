<?php
/**
 * CoCart Beta Tester Plugin Upgrader
 *
...
/**
 * Class CoCart_Beta_Tester_Plugin_Upgrader
 */
class CoCart_Beta_Tester_Plugin_Upgrader extends Plugin_Upgrader {
	...
	public function switch_version( $plugin, $args = array() ) {
		...
		$download_url = CoCart_Beta_Tester::instance()->get_download_url( $plugin_version );
